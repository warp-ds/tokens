...
import { toCamelCase, transformValue, getGeneratedDate, getBrandName } from "../helpers.js";
...
function getLightColor(dictionary, variant, brandName) {
  return dictionary.allProperties
...
StyleDictionary.registerFormat({
  ...
  formatter: function ({ dictionary, file, options }) {
    ...
    const swiftUIColorBlock = getLightColor(dictionary, "color", brandName);
    const uiColorBlock = getLightColor(dictionary, "uiColor", brandName);
