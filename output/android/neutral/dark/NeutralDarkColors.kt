...
internal object NeutralDarkIconColors : WarpIconColors {
    ...
    override val hoverStatic = Color(0xFF0055b1)
    override val invertedHoverStatic = Color(0xFFf0f0f2)
    override val activeStatic = Color(0xFF003977)
    override val invertedActiveStatic = Color(0xFFdedee3)
    override val selectedStatic = Color(0xFF0071eb)
    override val invertedSelectedStatic = Color(0xFF509df1)
    override val selectedHoverStatic = Color(0xFF0055b1)
    override val invertedSelectedHoverStatic = Color(0xFF78b3f4)
    override val selectedActiveStatic = Color(0xFF003977)
    override val invertedSelectedActiveStatic = Color(0xFFa0c9f7)
    ...
    override val primaryStatic = Color(0xFF0071eb)
    override val invertedPrimaryStatic = Color(0xFF509df1)
    override val secondaryStatic = Color(0xFF1b1b1f)
    override val invertedSecondaryStatic = Color(0xFFffffff)
    override val secondaryHoverStatic = Color(0xFF2b2b30)
    override val invertedSecondaryHoverStatic = Color(0xFFf0f0f2)
    override val secondaryActiveStatic = Color(0xFF47474f)
    override val invertedSecondaryActiveStatic = Color(0xFFdedee3)
    override val positiveStatic = Color(0xFF228000)
    override val invertedPositiveStatic = Color(0xFF8dc570)
    override val negativeStatic = Color(0xFFe00000)
    override val invertedNegativeStatic = Color(0xFFef8080)
    override val warningStatic = Color(0xFFf16c00)
    override val invertedWarningStatic = Color(0xFFff8725)
    override val infoStatic = Color(0xFF0071eb)
    override val invertedInfoStatic = Color(0xFF2887ee)
...
internal object NeutralDarkTextColors : WarpTextColors {
    ...
    override val linkStatic = Color(0xFF0071eb)
    override val invertedLinkStatic = Color(0xFF509df1)
    override val disabledStatic = Color(0xFFcacad1)
